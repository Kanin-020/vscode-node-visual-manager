...
interface CurrentVersionItemProps {
    ...
    uninstallNodeVersion: (version: string) => void;
    toggleNVMState: () => void;
        ...
        <div className="node-item">
            <div className="node-item-content">
                ...
                <span
                    ...
                    style={{
                        visibility:
                            version === currentVersionState && showCurrentLabel
                                ? 'visible'
                                : 'hidden',
                    }}
                ...
                <div className="options">
                    <a
                        title="Use version"
                        className="action"
                        onClick={() => useNodeVersion(version)}
                    >
                    ...
                    <a
                        title="Uninstall"
                        className="action"
                        onClick={() => uninstallNodeVersion(version)}
                    >
